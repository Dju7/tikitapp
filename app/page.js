...
export default function Home() {
  ...
  return (
    <main className="relative z-0 h-screen w-full bg-orange-400 flex flex-col justify-center items-center">
      ...
      <section className="z-10 w-[30%] h-[60%]  flex flex-col lg:flex-row justify-center items-center overflow-hidden bg-white p-4 rounded-xl">  
        <div className="h-[50%] lg:h-full w-full lg:w-[70%] flex flex-col justify-center items-center">
        <img src='913.png' />
        <h2 className="text-3xl text-neutral-800 font-bold mt-1">PC POMPIER</h2>
        <div className="min-h-14 w-full flex justify-center items-center">
        {error && (
                <p className="w-full bg-red-600 text-white font-bold text-center p-2">{error}</p>
              )}
        ...
        >
          ...
          className="w-full p-1 border-2 border-black focus:bg-orange-400 text-black font-bold"
          />
          ...
          <input 
          className="w-full p-1 border-2 border-black focus:bg-orange-400 "
          id="password" 
          name="password" 
          type="password"          
