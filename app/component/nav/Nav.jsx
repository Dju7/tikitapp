    ...
    return (
      <nav className="h-full w-full flex flex-col items-center justify-center gap-1 ">
        <div className="h-1/4 w-full bg-black flex flex-col text-orange-400 justify-center items-center gap-2 hover:bg-white hover:text-black transition-colors duration-300 ease-in-out">
          <Link href="/board"><FaHome className="text-5xl lg:text-6xl cursor-pointer transition-transform duration-300 ease-in-out hover:scale-110"/></Link>
        ...
        <div className="h-1/4 w-full bg-black flex flex-col text-orange-400 justify-center items-center gap-2 hover:bg-white hover:text-black transition-colors duration-300 ease-in-out">
        <Link href="/board/anomalies"><FaHouseMedicalFlag className="text-5xl lg:text-6xl cursor-pointer transition-transform duration-300 ease-in-out hover:scale-110" /></Link>
          <p className="text-xl lg:text-2xl">ANOMALIES</p>
        </div>
        <div className="h-1/4 w-full bg-black flex flex-col text-orange-400 justify-center items-center gap-2 hover:bg-white hover:text-black transition-colors duration-300 ease-in-out">
